...
namespace docsoft.entities
{
    ...
    public class RoleDal
    {
        ...
        public static Role Insert(Role Inserted)
        {
            ...
            obj[10] = new SqlParameter("ROLE_HomeUrl", Inserted.HomeUrl);
        ...
        public static Role Update(Role Updated)
        {
            ...
            obj[11] = new SqlParameter("ROLE_HomeUrl", Updated.HomeUrl);
        ...
        public static Role getFromReader(IDataReader rd)
        {
            ...
            if (rd.FieldExists("ROLE_HomeUrl"))
            {
                Item.HomeUrl = (String)(rd["ROLE_HomeUrl"]);
            }
            return Item; 
        }
        #endregion
