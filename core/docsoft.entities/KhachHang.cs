...
namespace docsoft.entities
{
    ...
    public class KhachHang : BaseEntity, BaseObject
    {
        ...
        public string Hint
        {
            get { return string.Format("{0} {1} {2} {3}", Ten, Mobile, Ma, DiaChi); }
        }

        public string Url
        {
            get { return string.Format("/lib/pages/KhachHang/Add.aspx?ID={0}", ID); }
        }
    ...
    public class KhachHangDal
    {
        ...
        public static KhachHang Insert(KhachHang item)
        {
            ...
            if (item.NgayCuoi > DateTime.MinValue)
            {
                obj[6] = new SqlParameter("KH_NgayCuoi", item.NgayCuoi);
            }
            else
            {
                obj[6] = new SqlParameter("KH_NgayCuoi", DBNull.Value);
            }
            obj[7] = new SqlParameter("KH_GioiTinh", item.GioiTinh);
            obj[8] = new SqlParameter("KH_Email", item.Email);
            obj[9] = new SqlParameter("KH_Mobile", item.Mobile);
            obj[10] = new SqlParameter("KH_Phone", item.Phone);
            obj[11] = new SqlParameter("KH_CMND", item.CMND);
            if (item.CMND_NgayCap > DateTime.MinValue)
            {
                obj[12] = new SqlParameter("KH_CMND_NgayCap", item.CMND_NgayCap);
            }
            else
            {
                obj[12] = new SqlParameter("KH_CMND_NgayCap", DBNull.Value);
            }
            obj[13] = new SqlParameter("KH_CMND_NoiCap", item.CMND_NoiCap);
            obj[14] = new SqlParameter("KH_Ym", item.Ym);
            obj[15] = new SqlParameter("KH_FacebookUid", item.FacebookUid);
            obj[16] = new SqlParameter("KH_LinhVuc_ID", item.LinhVuc_ID);
            obj[17] = new SqlParameter("KH_NguonGoc_ID", item.NguonGoc_ID);
            obj[18] = new SqlParameter("KH_NguonGoc_ChiTiet_ID", item.NguonGoc_ChiTiet_ID);
            obj[19] = new SqlParameter("KH_DiaChi", item.DiaChi);
            obj[20] = new SqlParameter("KH_KhuVuc_ID", item.KhuVuc_ID);
            if (item.NgayTao > DateTime.MinValue)
            {
                obj[21] = new SqlParameter("KH_NgayTao", item.NgayTao);
            }
            else
            {
                obj[21] = new SqlParameter("KH_NgayTao", DBNull.Value);
            }
            obj[22] = new SqlParameter("KH_NguoiGioiThieu", item.NguoiGioiThieu);
            obj[23] = new SqlParameter("KH_NguoiTao", item.NguoiTao);
            if (item.NgayCapNhat > DateTime.MinValue)
            {
                obj[24] = new SqlParameter("KH_NgayCapNhat", item.NgayCapNhat);
            }
            else
            {
                obj[24] = new SqlParameter("KH_NgayCapNhat", DBNull.Value);
            }
            obj[25] = new SqlParameter("KH_NguoiCapNhat", item.NguoiCapNhat);
            obj[26] = new SqlParameter("KH_NgungTheoDoi", item.NgungTheoDoi);
            obj[27] = new SqlParameter("KH_NoiBat", item.NoiBat);
            obj[28] = new SqlParameter("KH_ChiaSe", item.ChiaSe);
            obj[29] = new SqlParameter("KH_DanhGia", item.DanhGia);
            obj[30] = new SqlParameter("KH_KhongNhanEmail", item.KhongNhanEmail);
            obj[31] = new SqlParameter("KH_KhongDuocGoiDien", item.KhongDuocGoiDien);
            obj[32] = new SqlParameter("KH_ThoiGianGoiDien", item.ThoiGianGoiDien);
            obj[33] = new SqlParameter("KH_Anh", item.Anh);
            obj[34] = new SqlParameter("KH_TuVanVien", item.TuVanVien);
            obj[35] = new SqlParameter("KH_TiemNang", item.TiemNang);
            obj[36] = new SqlParameter("KH_Xoa", item.Xoa);
            obj[37] = new SqlParameter("KH_XoaAdm", item.XoaAdm);
        ...
        public static KhachHang getFromReader(IDataReader rd)
        {
            ...
            if (rd.FieldExists("KH_NgayCuoi"))
            {
                Item.NgayCuoi = (DateTime)(rd["KH_NgayCuoi"]);
            }
            ...
            if (rd.FieldExists("KH_CMND_NgayCap"))
            {
                Item.CMND_NgayCap = (DateTime)(rd["KH_CMND_NgayCap"]);
            }
            if (rd.FieldExists("KH_CMND_NoiCap"))
            {
                Item.CMND_NoiCap = (String)(rd["KH_CMND_NoiCap"]);
            }
            ...
            if (rd.FieldExists("KH_Xoa"))
            {
                Item.Xoa = (Boolean)(rd["KH_Xoa"]);
            }
            if (rd.FieldExists("KH_XoaAdm"))
            {
                Item.XoaAdm = (Boolean)(rd["KH_XoaAdm"]);
            }
