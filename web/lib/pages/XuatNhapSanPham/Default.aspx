<%@ Page Title="" Language="C#" MasterPageFile="~/lib/master/Admin_User.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="lib_pages_XuatNhapSanPham_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="panel-body" role="form">
                <div class="form-inline">
                    <div class="form-group pull-left">
                        <a href="/lib/pages/XuatNhapSanPham/Add.aspx" class="btn btn-primary">Thêm</a>      
                        <a href="/lib/pages/XuatNhapSanPham/Default.aspx" class="btn btn-success">
    ...
    <uc1:List runat="server" ID="List1" />
    <ul class="pagination">
        <%=paging %>
    </ul>
</asp:Content>
