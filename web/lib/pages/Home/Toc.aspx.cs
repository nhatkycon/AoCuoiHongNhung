...
public partial class lib_pages_Home_Toc : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (var con = DAL.con())
        {
            ...
            var list = SuKienDal.SelectPhieuDichVuForCalendarToc(con, cuoiThangTruoc, dauThangSau, Security.UserId.ToString());
            LichThang.List = list;
