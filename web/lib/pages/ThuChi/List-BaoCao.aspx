<%@ Page Title="" Language="C#" MasterPageFile="~/lib/master/Admin_User.master" AutoEventWireup="true" CodeFile="List-BaoCao.aspx.cs" Inherits="lib_pages_ThuChi_List_BaoCao" %>

<%@ Register Src="~/lib/ui/ThuChi/templates/Item-BaoCao.ascx" TagPrefix="uc1" TagName="ItemBaoCao" %>
<%@ Register Src="~/lib/ui/ThuChi/List-BaoCao.ascx" TagPrefix="uc1" TagName="ListBaoCao" %>
<%@ Register TagPrefix="uc2" TagName="DanhMucListByLdmMa" Src="~/lib/ui/HeThong/DanhMucListByLdmMa.ascx" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Tổng hợp thu chi</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <a href="/lib/pages/ThuChi/Add-Thu.aspx" class="btn btn-primary">Thêm</a>      
                        <a href="/lib/pages/ThuChi/List-Thu.aspx" class="btn btn-success">
    ...
    <uc1:ListBaoCao runat="server" ID="List" />
</asp:Content>
