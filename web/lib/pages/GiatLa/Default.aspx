<%@ Page Title="" Language="C#" MasterPageFile="~/lib/master/Admin_User.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="lib_pages_GiatLa_Default" %>

<%@ Register Src="~/lib/ui/GiatLa/List.ascx" TagPrefix="uc1" TagName="List" %>
            ...
            <div class="panel-body" role="form">
                <div class="form-inline">
                    <div class="form-group pull-left">
                        <a href="/lib/pages/GiatLa/Add.aspx" class="btn btn-primary">Thêm</a>      
                        <a href="/lib/pages/GiatLa/Default.aspx" class="btn btn-success">
