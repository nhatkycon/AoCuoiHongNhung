<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LichThang.ascx.cs" Inherits="lib_ui_KhoVay_LichThang" %>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="input-group">
                ...
                <input type="text" data-url="/lib/pages/PhieuDichVu/Default.aspx?NHANVIEN_ID=" data-src="/lib/ajax/NhanVien/Default.aspx" data-refId="NhanVien_ID" name="NhanVien_Ten" id="NhanVien_Ten" value="" placeholder="Chọn nhân viên" autofocus="" class="form-control LichThang-NhanVien-input NhanVien_Ten">
            </div>
        </div>
    </div>
        <hr/>
    ...
    $(document).ready(function () {
        $(".responsive-calendar").responsiveCalendar({
            ...
            events: {
                ...
                {%>
                , "<%=item.NgayBatDau.ToString("yyyy-MM-dd") %>": {"url": "<%=Target%>?Ngay=<%=item.NgayBatDau.ToString("dd/MM/yyyy") %>" }
                <%   } %>
            }
        });
    });
