<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Item-Kt.ascx.cs" Inherits="lib_ui_PhieuDichVu_templates_Item_Kt" %>
<%@ Import Namespace="linh.common" %>
<tr>
    <td class="">
        <a href="/lib/pages/PhieuDichVu/Add-Kt.aspx?ID=<%=Item.ID %>">
            <%=Item.MaStr %>
        </a>
    </td>
    <td>
        <a href="/lib/pages/KhachHang/Add-Kt.aspx?ID=<%=Item.KH_ID %>">
            <%=Item.KH_Ten %>
        </a>
    </td>
    <td>
    ...
    <td>
        <a href="/lib/pages/PhieuDichVu/List-Kt.aspx?TrangThai=<%=Item.TrangThai %>">
            <%=Item.TrangThaistr %>
        </a>
    </td>
</tr>