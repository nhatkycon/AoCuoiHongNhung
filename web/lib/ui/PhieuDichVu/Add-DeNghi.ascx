<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Add-DeNghi.ascx.cs" Inherits="lib_ui_PhieuDichVu_Add_DeNghi" %>
...
<div class="panel panel-default Normal-Pnl-Add PhieuDichVu-Pnl-Add"
    ...
    data-success="/lib/pages/PhieuDichVu/Add-DeNghi.aspx?ID="
    data-list="/lib/pages/PhieuDichVu/List-DeNghiChuaDuyet.aspx"
    >
    <div class="panel-heading">
        <uc1:AddTask_1_1  ListUrl="/lib/pages/PhieuDichVu/List-DeNghiChuaDuyet.aspx" runat="server" id="AddTask" />
    </div>
    <div class="panel-body">
        <div class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <label for="DuyetEkip" class="col-sm-2 control-label">
                    Duyệt Ekip:
                </label>
                <div class="col-sm-10">
                    ...
                    {%>
                        ...
                        <strong><%=Item.NguoiDuyet_Ten %></strong> ngày <%=Item.NgayDuyetEkip.ToString("dd/MM/yyyy") %>
                    <%}
                    else
                    {%>
                        <input class="DuyetEkip input-sm" id="DuyetEkip" name="DuyetEkip" type="checkbox"/>
                    <% } %>
                </div>
            </div>
            ...
            <div class="collapse<%=Item.TrangThai == 2 ? " in": "" %>" id="PhotoShopPnl">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input id="PTS_AnhBia" type="text" class="form-control money-input PTS_AnhBia" value="<%=Item.PTS_AnhBia %>" name="PTS_AnhBia"/>
                    </div>
                    <label for="PTS_AnhPhong" class="col-sm-2 control-label">Ảnh phóng:</label>
                    <div class="col-sm-2">
                        <input id="PTS_AnhPhong" type="text" class="form-control money-input PTS_AnhPhong" value="<%=Item.PTS_AnhPhong %>" name="PTS_AnhPhong"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input id="PTS_AnhBan" type="text" class="form-control money-input PTS_AnhBan" value="<%=Item.PTS_AnhBan %>" name="PTS_AnhBan"/>
                    </div>
            ...
            <hr/>
            <div class="form-group">
                <label for="TongTien" class="col-sm-2 control-label">Tổng:</label>
                <div class="col-sm-2">
                    <input id="TongTien" type="text" class="form-control money-input" value="<%=Item.TongTien %>" name="TongTien"/>
                </div>
                <label for="DatCoc" class="col-sm-2 control-label">Đặt cọc:</label>
                <div class="col-sm-2">
                    <input id="DatCoc" type="text" class="form-control money-input" value="<%=Item.DatCoc %>" name="DatCoc"/>
                </div>
                <label for="ConNo" class="col-sm-2 control-label">Còn nợ:</label>
                <div class="col-sm-2">
                    <input id="ConNo" type="text" class="form-control money-input" value="<%=Item.ConNo %>" name="ConNo"/>
                </div>
            </div>
    ...
    <div class="panel-footer">
        <uc1:AddTask_1_1 ListUrl="/lib/pages/PhieuDichVu/List-DeNghiChuaDuyet.aspx" runat="server" id="AddTask1" />
    </div>
</div>
