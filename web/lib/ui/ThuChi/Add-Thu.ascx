<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Add-Thu.ascx.cs" Inherits="lib_ui_ThuChi_Add_Thu" %>
...
<div class="panel panel-default Normal-Pnl-Add ThuChiThu-Pnl-Add"
    data-url="/lib/ajax/ThuChi/default.aspx"
    data-success="/lib/pages/ThuChi/Add-Thu.aspx?ID="
    data-list="/lib/pages/ThuChi/List-Thu.aspx"
    >
    ...
    <div class="panel-body">
        <uc1:AddCore runat="server" Thu="True" Id="AddCore" />
    </div>
