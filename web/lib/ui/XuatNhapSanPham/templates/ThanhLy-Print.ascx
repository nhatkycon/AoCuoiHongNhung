<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ThanhLy-Print.ascx.cs" Inherits="lib_ui_XuatNhapSanPham_templates_ThanhLy_Print" %>
...
<div class="print-frame">
    ...
    <p>
        <i>
            Căn cứ vào Hợp đồng cho thuê trang phục và phụ kiện số <strong><%=Item.MaStr %></strong>/HĐXSPPK-HN
    ...
    <p>
        Hai bên thống nhất ký biên bản thanh lý Hợp đồng cho thuê trang phục và phụ kiện số <strong><%=Item.MaStr %></strong>/HĐXSPPK-HN
    ...
    <div style="padding-left: 10px;">
        <p>
            ...
            cho thuê trang phục và phụ kiện số <strong><%=Item.MaStr %></strong>/HĐXSPPK-HN khi kết thúc hợp đồng
        </p>
   ...
   <p>
    ...
    <div style="padding-left: 10px;">
        <p>
           Bên A đồng ý thanh toán cho Bên B mức phí dịch vụ :   <strong>0</strong>VNĐ<br />
...
Hai bên thống nhất thanh lý Hợp đồng cho thuê trang phục và phụ kiện số <strong><%=Item.MaStr %></strong>/HĐXSPPK-HN ký ngày <%=Item.NgayTao.ToString("dd/MM/yyyy") %> giữa bên B và bên A. 
        </p>
    </div>
