<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HopDong-Print.ascx.cs" Inherits="lib_ui_XuatNhapSanPham_templates_HopDong_Print" %>
...
<div class="print-frame">
    <table width="100%" cellpadding="5" cellspacing="0">
        <tr>
            ...
            <td valign="top">
                ...
                <p align="center">
                    Hợp đồng số: <strong><%=Item.MaStr %></strong>/HĐXSPPK-HN
                </p>
            </td>
        </tr>
    </table>
    ...
    <div style="padding-left: 10px;">
        ...
        <p>
            Với số tiền cho thuê (mượn) là: <strong>0</strong> VNĐ
        </p>
    </div>
   <p>
        <strong>
