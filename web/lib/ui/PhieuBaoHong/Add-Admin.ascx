<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Add-Admin.ascx.cs" Inherits="lib_ui_PhieuBaoHong_Add_Admin" %>
...
<div class="panel panel-default Normal-Pnl-Add PhieuBaoHong-Pnl-Add"
    ...
    data-success="/lib/pages/PhieuBaoHong/Add-Admin.aspx?ID="
    data-list="/lib/pages/PhieuBaoHong/List-Admin.aspx"
    >
    <div class="panel-heading">
       <uc1:AddTask_1 AddUrl="/lib/pages/PhieuBaoHong/Add-Admin.aspx" ListUrl="/lib/pages/PhieuBaoHong/List-Admin.aspx" 
            ...
            {%>
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <%if (Item.Duyet)
                        {%>
                            <input class="Duyet input-sm" id="Duyet" checked="checked" name="Duyet" type="checkbox"/>
                        ...
                        {%>
                           <input class="Duyet input-sm" id="Duyet" name="Duyet" type="checkbox"/>
                        <% } %>
                    </div>
                </div>
            <%} %>
